...
## Project Structure
    ...
    ├── restless_sound_dev_76757  # Django project configurations
...
1. Clone this repo and `cd restless_sound_dev_76757`
...
2. Clone this repo and `cd restless_sound_dev_76757`
