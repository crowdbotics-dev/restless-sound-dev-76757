"""
Django settings for restless_sound_dev_76757 project.
...
ROOT_URLCONF = 'restless_sound_dev_76757.urls'
...
WSGI_APPLICATION = 'restless_sound_dev_76757.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_sound_dev_76757 API",
    "DESCRIPTION": "API documentation for restless_sound_dev_76757 App",
    "VERSION": "v1",
}
